...
M.set = function()
	...
	hl("NeoTreeVertSplit", { fg = colors.libadwaita_dark_alt, bg = colors.libadwaita_dark_alt })
	hl("NeoTreeWinSeparator", { fg = colors.libadwaita_dark_alt, bg = colors.libadwaita_dark_alt })
	hl("NeoTreeEndOfBuffer", { fg = colors.libadwaita_dark_alt, bg = colors.libadwaita_dark_alt })
	hl("NeoTreeNormalNC", { bg = colors.libadwaita_dark_alt })
	hl("NeoTreeNormal", { bg = colors.libadwaita_dark_alt })
	hl("NeoTreeDirectoryIcon", { bg = colors.libadwaita_dark_alt })
	hl("NeoTreeDirectoryName", { bg = colors.libadwaita_dark_alt })
	-- hl('NeoTreeSignColumn', { bg = colors.libadwaita_dark_alt, })
	-- hl('NeoTreeDirectoryIcon', { bg = colors.libadwaita_dark_alt, })
	-- hl('NeoTreeDirectoryName', { bg = colors.libadwaita_dark_alt, })
	-- hl('NeoTreeTitleBar', { bg = colors.libadwaita_dark_alt, })
	-- hl('NeoTreeBufferNumber', { bg = colors., })
	-- hl('NeoTreeCursorLine', { bg = colors., })
	-- hl('NeoTreeDimText', { bg = colors., })
	-- hl('NeoTreeDotfile', { bg = colors., })
	-- hl('NeoTreeFileNameOpened', { bg = colors., })
	-- hl('NeoTreeFilterTerm', { bg = colors., })
	-- hl('NeoTreeFloatBorder', { bg = colors., })
	-- hl('NeoTreeFloatTitle', { bg = colors., })
	-- hl('NeoTreeTitleBar', { bg = colors., })
	-- hl('NeoTreeGitAdded', { bg = colors., })
	-- hl('NeoTreeGitConflict', { bg = colors., })
	-- hl('NeoTreeGitDeleted', { bg = colors., })
	-- hl('NeoTreeGitIgnored', { bg = colors., })
	-- hl('NeoTreeGitModified', { bg = colors., })
	-- hl('NeoTreeGitUnstaged', { bg = colors., })
	-- hl('NeoTreeGitUntracked', { bg = colors., })
	-- hl('NeoTreeGitStaged', { bg = colors., })
	-- hl('NeoTreeHiddenByName', { bg = colors., })
	-- hl('NeoTreeIndentMarker', { bg = colors., })
	-- hl('NeoTreeExpander', { bg = colors., })
	-- hl('NeoTreeNormal', { bg = colors., })
	-- hl('NeoTreeNormalNC', { bg = colors., })
	-- hl('NeoTreeSignColumn', { bg = colors., })
	-- hl('NeoTreeStats', { bg = colors., })
	-- hl('NeoTreeStatsHeader', { bg = colors., })
	-- hl('NeoTreeStatusLine', { bg = colors., })
	-- hl('NeoTreeStatusLineNC', { bg = colors., })
	-- hl('NeoTreeRootName', { bg = colors., })
	-- hl('NeoTreeSymbolicLinkTarget', { bg = colors., })
	-- hl('NeoTreeTitleBar', { bg = colors., })
	-- hl('NeoTreeWindowsHidden', { bg = colors., })

	hl("DropBarIconKindDefaultNC", { bg = colors.libadwaita_dark_alt })
	hl("WinBar", { bg = colors.libadwaita_dark_alt })
	hl("WinBarNC", { bg = colors.libadwaita_dark_alt })
